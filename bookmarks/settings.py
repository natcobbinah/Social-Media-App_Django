...
INSTALLED_APPS = [
    # account app placed first in-order to override default accounts in admin
...
# social auth pipeline to create a profile object for a new user
...
SOCIAL_AUTH_FACEBOOK_KEY = env.str(
